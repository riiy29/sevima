...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url('assets/vendor/owlCarousel2/owl.carousel.min.css')?>" />
    <link rel="stylesheet" href="<?=base_url('assets/vendor/owlCarousel2/owl.theme-default.min.css')?>"/>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-1ycn6IcaQQ40/MKBW2W4Rhis/DbILU74C1vSrLJxCq57o941Ym01SwNsOMqvEBFlcgUa6xLiPY/NS5R+E6ztJQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link href='https://unpkg.com/boxicons@2.1.1/css/boxicons.min.css' rel='stylesheet'>
    <link href="<?=base_url('assets/vendor/bootstrap-5.1.3-dist/css/bootstrap.min.css')?>" rel="stylesheet">
