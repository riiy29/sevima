        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="content">
                        <div class="text-hero">
                            <h5> <span>Hai</span>, Muhammad Buchori</h5>
                            <h6>Yuk aktif belajar disini, silahkan pilih menu dibawah.</h6>  
                        </div>
                        <div class="login-act">
                            <div class="row">
                                <div class="col-lg-6 wrap">
                                    <a href="absen" target="_blank">
                                ...
                                <div class="col-lg-6">
                                    <a href="hubungiguru" target="_blank">
                                        <div class="button-teaser">
                                            <h3>Hubungi Guru</h3>
                                        </div>
                                    </a>
                                ...
                                <div class="col-lg-6">
                                    <a href="perpustakaan" target="_blank">
                                        <div class="button-teaser">
                                            <h3>Perpustakaan</h3>
                                        </div>
                                    </a>
